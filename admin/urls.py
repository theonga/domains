from .views import AdminView, Manage,  DomainListView, InvoiceView, RegisteredDomainView, PaymentView, SearchDomain, delete_user, UpdateAccountView, TransferDomainView
